    ...
    <div class="container">
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/london-eye-with-river-thames.jpg" alt="">
            <div class="card-body">
              <h3>United Kingdom</h3>
              <p>The United Kingdom is a state made up of the historic countries of England, Wales and Scotland.</p>
              <div class="star">
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/full-shot-friends-with-drinks-paris.jpg" alt="">
            <div class="card-body">
              <h3>France</h3>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/people-shiny-religions-ladies-reflection-largest.jpg" alt="">
            <div class="card-body">
              <h3>Pakistan</h3>
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/street-scape-positano-italy.jpg" alt="">
            <div class="card-body">
              <h3>Italy</h3>
              <p>Italy, officially the Italian Republic, is a country in Southern and Western Europe.</p>
              <div class="star">
                <i class="fa-solid fa-star checked"></i>
                <i class="fa-solid fa-star checked"></i>
                <i class="fa-solid fa-star checked"></i>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/mesmerizing-shot-famous-historic-taj-mahal-agra-india.jpg" alt="">
            <div class="card-body">
              <h3>India</h3>
              <p>
                India is a land of various cultures and a rich heritage. It will be an interesting tour. </p>
              <div class="star">
                <i class="fa-solid fa-star checked"></i>
                <i class="fa-solid fa-star "></i>
                <i class="fa-solid fa-star "></i>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card">
            <img src="Travel_tour/statue-liberty-with-cloudy-beautiful-sky.jpg" alt="">
            <div class="card-body">
              <h3>United States</h3>
              <p>The United States of America is the world's third largest country in size.</p>
              <div class="star">
                <i class="fa-solid fa-star checked"></i>
                <i class="fa-solid fa-star checked"></i>
                <i class="fa-solid fa-star checked"></i>
